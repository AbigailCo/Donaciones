...
export default function Login({ status, canResetPassword }) {
    ...
    const submit = (e) => {
        ...
        post(route('login'), {
            ...
            onSuccess: (response) => {
                // Verificar si el usuario está deshabilitado en la respuesta
                if (response.errors && response.errors.email === 'Este usuario está deshabilitado.') {
    ...
    return (
        <GuestLayout>
            ...
            {/* Mostrar mensaje de error si el usuario está deshabilitado */}
            {errors.email && <div className="mb-4 font-medium text-sm text-red-600">{errors.email}</div>}
